...
function getDelayedPaymentsData() {
    try {
        ...
        const execution = Utils.sql(
            ...
            `,
            [billingDataSet, simInventoryDataSet, rfpSummaryDataSet, paymentDataSet]
        );
...
function getReportsData() {
    const simReportsData = getSimReportsData();
    const delayedPaymentsData = getDelayedPaymentsData();

    console.log(typeof simReportsData);
    console.log(typeof delayedPaymentsData);

    return [simReportsData, delayedPaymentsData];
}
